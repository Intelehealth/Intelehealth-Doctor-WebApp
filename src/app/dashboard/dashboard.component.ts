...
export class DashboardComponent implements OnInit {
  ...
  AppointmentTableComponent: AppointmentTableComponent;
  ...
  constructor(
    ...
    this.pvs.appointment_button =
      this.pvs.appointment_button && !this.isMCCUser;
    this.displayedColumns1 = this.displayedColumns1.filter(
  ...
  getCompletedVisits(page: number = 1) {
    this.visitService
      .getCompletedVisits(this.specialization, page)
  ...
  getAppointments() {
    ...
    this.appointmentService
      ...
      .subscribe((res: ApiResponseModel) => {
        ...
        this.dataSource7.filterPredicate = (data, filter: string) =>
